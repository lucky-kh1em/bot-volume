...
contract BakerySwapPair is IBakerySwapPair, BakerySwapBEP20 {
    ...
    function _safeTransfer(
        ...
        require(
            ...
            "BakerySwapPair: TRANSFER_FAILED"
        );
    }
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        require(
            amount0 > 0 && amount1 > 0,
            "BakerySwapPair: INSUFFICIENT_LIQUIDITY_BURNED"
        );
    ...
    function swap(
        ...
        require(
            ...
            "BakerySwapPair: INSUFFICIENT_OUTPUT_AMOUNT"
        );
        (uint112 _reserve0, uint112 _reserve1, ) = getReserves(); // gas savings
        require(
            amount0Out < _reserve0 && amount1Out < _reserve1,
            "BakerySwapPair: INSUFFICIENT_LIQUIDITY"
        );
        ...
        require(
            ...
            "BakerySwapPair: INSUFFICIENT_INPUT_AMOUNT"
        );
        {
